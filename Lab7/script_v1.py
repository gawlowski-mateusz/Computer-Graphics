...
def compile_shaders():
    vertex_shader_source = """
        ...
        out vec4 vertex_color;      // vertex color variable created

        void main(void) {
            gl_Position = P_matrix * V_matrix * M_matrix * position;
            vertex_color = vec4(0.2, 0.9, 0.1, 1.0);    // vertex color values
        }
    """
    ...
    fragment_shader_source = """
        ...
        in vec4 vertex_color;   // input variable
        out vec4 color;

        void main(void) {
            color = vertex_color;   // assign vertex_color value
        }
    """
